...
# ITI-GEN + ControlNet + SW-Guidance
# python ITIGen-ControlNet-SW-Guidance.py ^
#   --outdir "./outputs/full_pipeline" ^
#   --control-type pose ^
#   --control-image "./happyPerson.jpg" ^
#   --sw-enabled ^
#   --sw-reference-image "./pastel.jpeg" ^
#   --sw-loss-type 1 ^
...
# python ITIGen-ControlNet-SW-Guidance.py ^
#   --outdir "./outputs/full_pipeline_fast" ^
#   --control-type pose ^
#   --control-image "./happyPerson.jpg" ^
#   --sw-enabled ^
#   --sw-reference-image "./pastel.jpeg" ^
...
#   --sw-M 10 ^
#   --sw-u-lr 0.2 ^
#   --sw-stop-guidance 0.99 ^
#   --sw-decode-start 10 ^
#   --sw-downscale-min 32 ^
#   --sw-downscale-max 48 ^
#   --sw-num-projections 50 ^
#   --attr-list "Male,MSTESkin_tone" ^
#   --filters Male_Negative MSTESkin_tone_2 ^
#   --prompt "a headshot of a person" ^
#   --generate-image-prompt "A picture of a doctor" ^
...
# python ITIGen-ControlNet-SW-Guidance.py ^
#   --outdir "./outputs/fixed_guidance2" ^
#   --control-type pose ^
#   --control-image "./happyPerson.jpg" ^
#   --sw-enabled ^
#   --sw-reference-image "./pastel.jpeg" ^
...
# python ITIGen-ControlNet-SW-Guidance.py ^
#   --outdir "./outputs/fixed_guidance4" ^
#   --control-type pose ^
...
#   --sw-M 5 ^
#   --sw-u-lr 0.04 ^
#   --sw-stop-guidance 0.5 ^
#   --sw-decode-start 0 ^
#   --sw-downscale-min 48 ^
#   --sw-downscale-max 64 ^
#   --sw-num-projections 100 ^
#   --attr-list "Male,MSTESkin_tone" ^
#   --filters Male_Positive MSTESkin_tone_10 ^
#   --prompt "a headshot of a person" ^
#   --generate-image-prompt "A picture of a doctor" ^
#   --num_inference_steps 50 ^
#   --guidance_scale 7.5 ^
...
# python ITIGen-ControlNet-SW-Guidance.py ^
#   --outdir "./outputs/fixed_guidance5" ^
#   --control-type pose ^
#   --control-image "./happyPerson.jpg" ^
#   --attr-list "Male,MSTESkin_tone" ^
#   --filters Male_Positive MSTESkin_tone_10 ^
...
# python ITIGen-ControlNet-SW-Guidance.py ^
#   --outdir "./outputs/fixed_guidance6" ^
#   --attr-list "Male,MSTESkin_tone" ^
#   --filters Male_Positive MSTESkin_tone_10 ^
#   --prompt "a headshot of a person" ^
#   --generate-image-prompt "A picture of a doctor" ^
...
# python ITIGen-ControlNet-SW-Guidance.py ^
#   --outdir "./outputs/pose_test_manual2" ^
#   --control-type pose ^
#   --control-image "./basic_pose.jpg" ^
...
# python ITIGen-ControlNet-SW-Guidance.py ^
#   --outdir "./outputs/pose_test_manual3" ^
#   --control-type pose ^
#   --control-image "./basic_pose.jpg" ^
#   --controlnet-scale 0.8 ^
#   --n_iter 3 ^
...
#   --generate-image-prompt "A picture of a doctor in a hospital" ^
#   --sw-enabled ^
#   --sw-reference-image "./van_gogh_wheatfield.jpeg" ^
#   --sw-loss-type 1 ^
#   --sw-M 5 ^
#   --sw-u-lr 0.04 ^
#   --sw-stop-guidance 0.5 ^
...
# python ITIGen-ControlNet-SW-Guidance.py ^
#   --outdir "./outputs/SW_CCv2_ITIGEN_POSE" ^
#   --n_iter 3 ^
#   --seed 42 ^
#   --guidance_scale 7 ^
#   --num_inference_steps 50 ^
...
#   --guidance_scale 7 ^
#   --num_inference_steps 50 ^
#   --attr-list "CCv2_Gender,CCv2_MSTESkin_tone" ^
# #   --filters Male_Negative MSTESkin_tone_2 ^
#   --prompt "an image of a person" ^
#   --generate-image-prompt "An image of a doctor" ^
# #   --sw-enabled ^
# #   --sw-reference-image "./van_gogh_wheatfield.jpeg" ^
# #   --sw-loss-type 1 ^
# #   --sw-M 5 ^
...
# python ITIGen-ControlNet-SW-Guidance.py ^
#   --outdir "./outputs/Object_Test" ^
#   --n_iter 3 ^
#   --seed 45 ^
#   --guidance_scale 7 ^
#   --num_inference_steps 50 ^
#   --attr-list "Male,Chubby,Black_Hair,Blond_Hair,Bald,Mustache,Wearing_Hat" ^
#   --prompt "a headshot of a person" ^
#   --generate-image-prompt "A picture of a doctor" ^
#   --save-intermediate ^
#   --load-model-epoch 9 ^
#   --filters Male_Positive Chubby_Negative Black_Hair_Negative Blond_Hair_Negative Bald_Positive Mustache_Negative Wearing_Hat_Negative