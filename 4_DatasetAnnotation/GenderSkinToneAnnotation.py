...
#         """
#         Convert raw model output to (mst_label, bin_label) per sample.

#         classification : argmax → class index → MST or bin
#         regression     : scalar already in [0, 10] → round to nearest MST
#         coral          : count how many thresholds are exceeded (logit > 0)
#         """
#         results = []
...
#                     bin_label = int(pred)
#                     mst_label = int(pred)           # class index IS the bin
#                 else:
#                     mst_label = int(pred) + 1       # 0-indexed class → MST 1-N
#                     bin_label = mst_to_bin(mst_label)
#                 results.append((mst_label, bin_label))

#         elif self.mode == "regression":
#             # LabelMapper trains on 0-indexed targets (MST 1→0.0 … MST 10→9.0),
#             # so the model outputs values in [0, 9]. Add 1 to recover MST 1-10 scale.
#             preds = logits.squeeze(-1).cpu().numpy()
#             if preds.ndim == 0:          # single-sample edge case
#                 preds = preds.reshape(1)

#             print(f"[DEBUG] raw outputs → min={preds.min():.4f}  max={preds.max():.4f}  "f"mean={preds.mean():.4f}  sample={preds[:5]}")

#             for val in preds:
#                 mst_label = int(np.clip(round(float(val) + 1), 1, 10))
#                 bin_label = mst_to_bin(mst_label)
#                 results.append((mst_label, bin_label))

#         elif self.mode == "coral":
#             # CORAL: predicted rank = number of thresholds exceeded
...
#                     mst_label = int(rank)
#                 else:
#                     mst_label = int(rank) + 1       # rank 0 → MST 1
#                     bin_label = mst_to_bin(mst_label)
#                 results.append((mst_label, bin_label))
...
#         """Single-image prediction. Returns (mst_label, bin_label)."""
#         try:
...
#         """
#         Batch prediction. Returns list of (mst_label, bin_label) tuples.
#         """
#         if not img_pils:
#             return []
#         try:
...
#     # ── SANITY CHECK: run one image through and print pre-clamp logits ──
#     test_img = valid_images[0] if False else Image.new("RGB", (224, 224), color=(180, 140, 110))
#     test_tensor = skin_model.transform(test_img).unsqueeze(0).to(skin_model.device)
#     with torch.no_grad():
#         feats = skin_model.model.features(test_tensor)
#         feats = skin_model.model.avgpool(feats)
#         feats = torch.flatten(feats, 1)
#         raw_logits = skin_model.model.classifier(feats)
#     print(f"[SANITY] pre-clamp: min={raw_logits.min().item():.4f}  max={raw_logits.max().item():.4f}  mean={raw_logits.mean().item():.4f}")
...
#
# ── ResNet18 · Classification · LAB (4-class) ─────────────────────────
# python GenderSkinToneAnnotation.py \
#     --image_dir   "path/to/images" \
#     --output_dir  "path/to/output" \
#     --skin_model_path "F:/VGG_MST_Testing/Models/ResNet18_4Classification_LAB/best.pt" \
#     --skin_arch   resnet18 \
#     --skin_mode   classification \
#     --num_classes 4 \
#     --skin_output_mode unbinned \
...
#     --batch_size  32
#
# ── ResNet18 · Regression · LAB ───────────────────────────────────────
# python GenderSkinToneAnnotation.py \
#     --image_dir   "path/to/images" \
#     --output_dir  "path/to/output" \
#     --skin_model_path "F:/VGG_MST_Testing/Models/ResNet18_4CRegression_LAB/best.pt" \
#     --skin_arch   resnet18 \
#     --skin_mode   regression \
#     --num_classes 4 \
#     --skin_input  lab \
#     --lab_stats_path "models/lab_stats.npz" \
#     --batch_size  64
#
# ── ResNet18 · CORAL · LAB (4-class) ─────────────────────────────────
# python GenderSkinToneAnnotation.py \
#     --image_dir   "path/to/images" \
#     --output_dir  "path/to/output" \
#     --skin_model_path "F:/VGG_MST_Testing/Models/ResNet18_4CCoral_LAB/best.pt" \
#     --skin_arch   resnet18 \
#     --skin_mode   coral \
#     --num_classes 4 \
#     --skin_input  lab \
...
#     --batch_size  32
#
# ── VGG16 · Classification · LAB (3-class bins, FixedBG) ─────────────
# python GenderSkinToneAnnotation.py \
#     --image_dir   "path/to/images" \
#     --output_dir  "path/to/output" \
#     --skin_model_path "F:/VGG_MST_Testing/Models/ResNet18_3Classification_LAB_FixedBG/best.pt" \
#     --skin_arch   resnet18 \
#     --skin_mode   classification \
#     --num_classes 3 \
...
# "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\4_DatasetAnnotation\.venv\Scripts\python.exe" GenderSkinToneAnnotation.py ^
# --image_dir "E:\ImageRetrieval\StableDiffusionGeneratedImages\valid" ^
# --target_subdir "face_crops" ^
# --output_dir "E:\ImageRetrieval\StableDiffusionGeneratedImages_Annotations" ^
...
# "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\4_DatasetAnnotation\.venv\Scripts\python.exe" GenderSkinToneAnnotation.py ^
# --image_dir "F:\ImageRetrieval\Professions_125k_ISCO_Aligned_1k_Subset" ^
# --target_subdir "facemesh" ^
# --output_dir "F:\ImageRetrieval\Professions_125k_ISCO_Aligned_1k_Subset" ^
# --skin_model_path "F:\VGG_MST_Testing\Models\VGG16_10Regression_RGB\best_model.pth" ^
# --skin_arch vgg16 ^
# --skin_mode regression ^
# --num_classes 10 ^
...
# --image_dir "E:\ImageRetrieval\StableDiffusionGeneratedImages\valid" ^
# --target_subdir "face_crops" ^
# --output_dir "E:\ImageRetrieval\StableDiffusionGeneratedImages_Annotations_2" ^
# --skin_model_path "F:\VGG_MST_Testing\Models\VGG16_10Regression_LAB\best_model.pth" ^
# --skin_arch vgg16 ^
# --skin_mode regression ^
# --num_classes 10 ^
# --skin_output_mode unbinned ^
# --skin_input  lab ^
# --lab_stats_path "F:\VGG_MST_Testing\Models\VGG16_10Regression_LAB\lab_statistics.json"


# "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\4_DatasetAnnotation\.venv\Scripts\python.exe" GenderSkinToneAnnotation.py ^
# --image_dir "E:\ImageRetrieval\StableDiffusionGeneratedImages\valid" ^
# --target_subdir "face_crops" ^
# --output_dir "E:\ImageRetrieval\StableDiffusionGeneratedImages_Annotations_3" ^
# --skin_model_path "F:\VGG_MST_Testing\Models\VGG16_10Regression_RGB\best_model.pth" ^
# --skin_arch vgg16 ^
# --skin_mode regression ^
# --num_classes 10 ^
...
# "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\4_DatasetAnnotation\.venv\Scripts\python.exe" GenderSkinToneAnnotation.py ^
# --image_dir "F:\Thesis\Fairface_Dataset\Segmented_FairFace\validation" ^
# --output_dir "E:\ImageRetrieval\AnnotationTestMapped" ^
# --skin_model_path "F:\VGG_MST_Testing\Models\VGG16_10Regression_RGB\best_model.pth" ^
# --skin_arch vgg16 ^
# --skin_mode regression ^
# --num_classes 10 ^
# --skin_output_mode unbinned ^
# --skin_input  rgb ^
# --label_mapping_path "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\4_DatasetAnnotation\SkinToneClassificationModels\VGG16_MST_Testing\label_mapping_10class.json"

# "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\4_DatasetAnnotation\.venv\Scripts\python.exe" GenderSkinToneAnnotation.py ^
# --image_dir "F:\Thesis\Fairface_Dataset\Segmented_FairFace\validation" ^
# --output_dir "E:\ImageRetrieval\AnnotationTestLABMapped" ^
# --skin_model_path "F:\VGG_MST_Testing\Models\VGG16_10Classification_LAB\best_model.pth" ^
# --skin_arch vgg16 ^
# --skin_mode classification ^
# --num_classes 10 ^
# --skin_output_mode unbinned ^
# --skin_input  lab ^
# --lab_stats_path "F:\VGG_MST_Testing\Models\VGG16_10Classification_LAB\lab_statistics.json" ^
# --label_mapping_path "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\4_DatasetAnnotation\SkinToneClassificationModels\VGG16_MST_Testing\label_mapping_10class.json"

# "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\4_DatasetAnnotation\.venv\Scripts\python.exe" GenderSkinToneAnnotation.py ^
# --image_dir "F:\Thesis\Fairface_Dataset\Segmented_FairFace\validation" ^
# --output_dir "E:\ImageRetrieval\AnnotationTestMapped3" ^
# --skin_model_path "F:\VGG_MST_Testing\Models\VGG16_3Regression_RGB\best_model.pth" ^
# --skin_arch vgg16 ^
# --skin_mode regression ^
# --num_classes 3 ^
# --skin_output_mode unbinned ^
# --skin_input  rgb ^
# --label_mapping_path "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\4_DatasetAnnotation\SkinToneClassificationModels\VGG16_MST_Testing\label_mapping_3class.json"

# "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\4_DatasetAnnotation\.venv\Scripts\python.exe" GenderSkinToneAnnotation.py ^
# --image_dir "F:\Thesis\Fairface_Dataset\Segmented_FairFace\validation" ^
# --output_dir "E:\ImageRetrieval\AnnotationTestLABMapped3" ^
# --skin_model_path "F:\VGG_MST_Testing\Models\VGG16_3Classification_LAB_FixedBG\best_model.pth" ^
# --skin_arch vgg16 ^
# --skin_mode classification ^
# --num_classes 3 ^
# --skin_output_mode unbinned ^
