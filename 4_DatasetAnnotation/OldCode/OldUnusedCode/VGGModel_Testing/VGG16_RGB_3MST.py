...
def build_dataloaders(csv_path, image_dir, batch_size, val_ratio,
    ...
    train_dataset = SkinToneClassificationDataset(train_df, image_dir, train_tf, label_mode)
    val_dataset   = SkinToneClassificationDataset(val_df, image_dir, val_tf, label_mode)
