...
# .\.venv\Scripts\python.exe YoloFilteringImageRetrieval.py --input_root "F:\Thesis\Test" --output_root "F:\Thesis\Test\RetrievedImages" --jsonl_path "F:\Thesis\Test\retrieval_results_batchsize_10.jsonl" --yolo_face_model_path "models/yolov8n-face.pt" --mode "copy" --batch_size 128