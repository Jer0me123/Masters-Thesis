...
# .\.venv\Scripts\python.exe YoloFilteringTest.py --input_root "G:\Thesis" --output_root "F:\Thesis\Test\RetrievedImages2" --jsonl_path "D:\ISCO_aligned_125k_retrieval_results_batchsize_10.jsonl" --yolo_face_model_path "models/yolov8n-face.pt" --yolo_person_model_path "models/yolov8n.pt" --mode "copy" --batch_size 1