...
# python Depth.py --image_dir "F:\ImageRetrieval\Professions_125k_ISCO_Aligned_1k_Subset" --resize 224 224 --batch_size 16 --num_workers 8 --output_dir "F:\ImageRetrieval\SpuriousFeatureImages\Professions_125k_ISCO_Aligned_1k_Subset\Depth" --exclude_dirs facemesh --device cuda --model_size Small

# python Depth.py --image_dir "E:\ImageRetrieval\StableDiffusionGeneratedImages\valid" --resize 224 224 --batch_size 16 --num_workers 8 --output_dir "F:\ImageRetrieval\SpuriousFeatureImages\StableDiffusionImages\Depth" --exclude_dirs face_crops --device cuda --model_size Small

# python Depth.py --image_dir "F:\ImageRetrieval\Coco" --resize 224 224 --batch_size 16 --num_workers 8 --output_dir "F:\ImageRetrieval\SpuriousFeatureImages\Coco\Depth" --exclude_dirs facemesh --device cuda --model_size Small
