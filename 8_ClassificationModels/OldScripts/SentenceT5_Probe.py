...
# Example CLI:
# python SentenceT5_Probe.py --splits_json test_sentenceT5_gender.json --task gender --seeds 0 1 2 3 4 --bootstrap --out_dir out_sentence_t5_gender --lr 2e-5 --weight_decay 0.01
