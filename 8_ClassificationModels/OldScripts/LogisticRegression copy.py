...
#     --splits_json "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\7_DatasetPreparation\UniversalSplits\DatasetClassification\splits_face_combined_stratified_meanrgb_10k.json" ^
#     --task "gender" ^
#     --feature_type "mean_rgb" ^
#     --bootstrap ^
#     --out_dir "test_meanrgb"




# python LogisticRegression.py ^
#     --splits_json "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\7_DatasetPreparation\output_same_features.json" ^
#     --task "gender" ^
#     --feature_type "mean_rgb" ^
#     --bootstrap ^
#     --out_dir "test_meanrgb"