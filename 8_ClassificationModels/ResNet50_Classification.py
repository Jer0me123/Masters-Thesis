...
# python ResNet50_Classification_Updated.py ^
# --splits_json "F:\ImageRetrieval\SpuriousFeatureImages\StableDiffusionImages\_SPLITS\Base\splits_gender_face_stratified.json" ^
# --task gender ^
# --seeds 0 ^
# --bootstrap ^
# --backbone resnet50 ^
...
# --patience 5 ^
# --save_mode best ^
# --out_dir "output_gender_classification\StableDiffusion\Base" ^
# --epochs 30

# python ResNet50_Classification_Updated.py ^
# --splits_json "F:\ImageRetrieval\SpuriousFeatureImages\StableDiffusionImages\_SPLITS\Depth\splits_gender_face_stratified_depth.json" ^
# --task gender ^
# --seeds 0 ^
# --bootstrap ^
# --backbone resnet50 ^
...
# --patience 5 ^
# --save_mode best ^
# --out_dir "output_gender_classification\StableDiffusion\Depth" ^
# --epochs 30 ^
# --lrs 0.01 0.001 ^
# --wds 1e-03 1e-05

# python ResNet50_Classification_Updated.py ^
# --splits_json "F:\ImageRetrieval\SpuriousFeatureImages\StableDiffusionImages\_SPLITS\EdgeDetection\edges_canny\splits_gender_face_stratified_edge.json" ^
# --task gender ^
# --seeds 0 ^
# --bootstrap ^
# --backbone resnet50 ^
...
# --patience 5 ^
# --save_mode best ^
# --out_dir "output_gender_classification\StableDiffusion\Edge" ^
# --epochs 30 ^
# --lrs 0.01 0.001 ^
# --wds 1e-03 1e-05

# python ResNet50_Classification_Updated.py ^
# --splits_json "F:\ImageRetrieval\SpuriousFeatureImages\StableDiffusionImages\_SPLITS\Occlusion\Full_NoBg\splits_gender_face_stratified_full_noBg.json" ^
# --task gender ^
# --seeds 0 ^
# --bootstrap ^
# --backbone resnet50 ^
...
# --patience 5 ^
# --save_mode best ^
# --out_dir "output_gender_classification\StableDiffusion\Occlusion_FullNoBg" ^
# --epochs 30 ^
# --lrs 0.01 0.001 ^
# --wds 1e-03 1e-05

# python ResNet50_Classification_Updated.py ^
# --splits_json "F:\ImageRetrieval\SpuriousFeatureImages\StableDiffusionImages\_SPLITS\Occlusion\MaskRect\splits_gender_face_stratified_mask_rect.json" ^
# --task gender ^
# --seeds 0 ^
# --bootstrap ^
# --backbone resnet50 ^
...
# --patience 5 ^
# --save_mode best ^
# --out_dir "output_gender_classification\StableDiffusion\Occlusion_MaskRect" ^
# --epochs 30 ^
# --lrs 0.01 0.001 ^
# --wds 1e-03 1e-05

# python ResNet50_Classification_Updated.py ^
# --splits_json "F:\ImageRetrieval\SpuriousFeatureImages\StableDiffusionImages\_SPLITS\Occlusion\MaskRect_NoBg\splits_gender_face_stratified_mask_rect_noBg.json" ^
# --task gender ^
# --seeds 0 ^
# --bootstrap ^
# --backbone resnet50 ^
...
# --patience 5 ^
# --save_mode best ^
# --out_dir "output_gender_classification\StableDiffusion\Occlusion_MaskRect_NoBg" ^
# --epochs 30 ^
# --lrs 0.01 0.001 ^
# --wds 1e-03 1e-05

# python ResNet50_Classification_Updated.py ^
# --splits_json "F:\ImageRetrieval\SpuriousFeatureImages\StableDiffusionImages\_SPLITS\Occlusion\MaskSegm\splits_gender_face_stratified_mask_segm.json" ^
# --task gender ^
# --seeds 0 ^
# --bootstrap ^
# --backbone resnet50 ^
...
# --patience 5 ^
# --save_mode best ^
# --out_dir "output_gender_classification\StableDiffusion\Occlusion_MaskSegm" ^
# --epochs 30 ^
# --lrs 0.01 0.001 ^
# --wds 1e-03 1e-05

# python ResNet50_Classification_Updated.py ^
# --splits_json "F:\ImageRetrieval\SpuriousFeatureImages\StableDiffusionImages\_SPLITS\Occlusion\MaskSegm_NoBg\splits_gender_face_stratified_mask_segm_noBg.json" ^
# --task gender ^
# --seeds 0 ^
# --bootstrap ^
# --backbone resnet50 ^
...
# --patience 5 ^
# --save_mode best ^
# --out_dir "output_gender_classification\StableDiffusion\Occlusion_MaskSegm_NoBg" ^
# --epochs 30 ^
# --lrs 0.01 0.001 ^
# --wds 1e-03 1e-05


# ------------------------------------------------------------------ Professions_125k_ISCO_Aligned_1k_Subset ------------------------------------------------------------------ # 

# python ResNet50_Classification_Updated.py ^
# --splits_json "F:\ImageRetrieval\SpuriousFeatureImages\Professions_125k_ISCO_Aligned_1k_Subset\_SPLITS\Base\splits_gender_face_stratified.json" ^
# --task gender ^
# --seeds 0 ^
# --bootstrap ^
# --backbone resnet50 ^
...
# --patience 5 ^
# --save_mode best ^
# --out_dir "output_gender_classification\Professions_125k_ISCO_Aligned_1k_Subset\Base" ^
# --epochs 30

# python ResNet50_Classification_Updated.py ^
# --splits_json "F:\ImageRetrieval\SpuriousFeatureImages\Professions_125k_ISCO_Aligned_1k_Subset\_SPLITS\Depth\splits_gender_face_stratified.json" ^
# --task gender ^
# --seeds 0 ^
# --bootstrap ^
# --backbone resnet50 ^
...
# --patience 5 ^
# --save_mode best ^
# --out_dir "output_gender_classification\Professions_125k_ISCO_Aligned_1k_Subset\Depth" ^
# --epochs 30 ^
# --lrs 0.01 0.001 
# --wds 1e-03 1e-05