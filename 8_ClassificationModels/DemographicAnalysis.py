# """
# Demographic Distribution Analysis and Plotting

# Extracts all results needed for the evaluation section and produces
# all figures from annotation JSONL files.

# Usage:
#     python demographic_analysis.py \
#         --laion    path/to/laion_annotations.jsonl \
#         --sd       path/to/sd_annotations.jsonl \
#         --isco-csv path/to/job_list_isco_mapped.csv \
#         --out      results/

# Outputs:
#     CSV files:
#         aggregate_gender.csv
#         aggregate_skintone.csv
#         laion_per_profession_gender.csv
#         sd_per_profession_gender.csv
#         laion_per_profession_skintone.csv
#         sd_per_profession_skintone.csv
#         laion_isco_gender.csv
#         sd_isco_gender.csv
#         laion_isco_skintone.csv
#         sd_isco_skintone.csv
#         top_gender_skew.csv
#         top_skintone_skew.csv
#         amplification_analysis.csv
#         summary.txt
...
#     ax.bar(x-w/2, lf, w, label="Re-LAION-5B", color=LAION_COLOUR, alpha=0.85, edgecolor="white")
#     ax.bar(x+w/2, sf, w, label="SDv1.5",      color=SD_COLOUR,    alpha=0.85, edgecolor="white")
#     ax.axhline(50, color="black", lw=0.8, ls="--", alpha=0.6, label="Parity (50%)")
#     ax.set_xticks(x); ax.set_xticklabels(labels, fontsize=8.5)
#     ax.set_ylabel("Female Proportion (%)", fontsize=11); ax.set_ylim(0, 80)
...
# # python DemographicAnalysis.py ^
# #     --laion "F:\ImageRetrieval\Professions_125k_ISCO_Aligned_1k_Subset\annotations.jsonl" ^
# #     --sd    "E:\ImageRetrieval\StableDiffusionGeneratedImages_Annotations\annotations.jsonl" ^
# #     --isco-csv "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\GenderSkinToneProxy\Global\job_list_isco_mapped.csv" ^
# #     --out   demographic_results/
...
#     --sd        "E:\ImageRetrieval\StableDiffusionGeneratedImages_Annotations\annotations.jsonl" ^
#     --isco-csv  "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\GenderSkinToneProxy\Global\job_list_isco_mapped.csv" ^
#     --us-bls    "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\GenderSkinToneProxy\US\USBureauOfLaborStatistics\us_profession_demographics_enhanced.csv" ^
#     --global-ilo "C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\GenderSkinToneProxy\Global\globalDemographics\global_gender_split_global_per_job.csv" ^
#     --out       demographic_results2/