...
if __name__ == "__main__":
    # Setup paths
    COCO_ANNOTATIONS = r"C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\Spurious_Feature\PoseEstimation\Coco\annotations\person_keypoints_val2017.json"
    COCO_IMAGES = r"C:\MastersRepos\ARI5902-Research-Topics-in-AI\LAION-5B Testing\Spurious_Feature\PoseEstimation\Coco\val2017"
    ...
    models_to_test = {
        ...
        "HRNet-W48 (Standard)": (MMPoseTopDownEstimator("w48_256", use_yolo=True), False),
        "HRNet-W48 (Oracle)": (MMPoseTopDownEstimator("w48_256", use_yolo=False), True),
    }
...
# .venv\Scripts\python.exe model_evaluation_comparison.py