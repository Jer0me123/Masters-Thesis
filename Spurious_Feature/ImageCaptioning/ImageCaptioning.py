...
#     """
#     High-performance image loader with TurboJPEG fallback to PIL.
#     """
#     def __init__(self):
...
#             self.use_turbo = True
#             print("[Loader] TurboJPEG enabled")
#         except Exception as e:
#             print(f"[Loader] TurboJPEG unavailable ({e}), using PIL")
#         # else:
#         #     print("[Loader] Using PIL for image loading")

#     def load(self, path: str) -> Image.Image:
#         """Load image and return as PIL Image in RGB mode."""
#         try:
#             ext = os.path.splitext(path)[1].lower()
            
#             # Use TurboJPEG for JPEG files if available
